...
function eupagopayshop_link($params) {
    $client = new euPagoPayshop();
    return $client->render($params);
}

if(!class_exists('euPagoPayshop')){
    class euPagoPayshop{
        ...
        public $config = array(
            ...
            'payment_logo' => 'https://xxxxx.pt/templates/six/img/payshop.png',
        ...
        public function requestPayment($key, $invoiceId, $amount) {
            try{
                ...
                $result = $client->gerarReferenciaPS(array(
                    'chave' => $key,
                    'valor' => $amount,
                    'id' => $invoiceId
                ));
        ...
        public function getTemplate($reference,$amount){
            ...
            <tr>
                <td align="left" style="font-size:small;font-weight:bold;padding-left:15px;">'.Lang::trans('paymentpayshop_ref').':</td>
                <td align="left" style="font-size:small;">' . $reference . ' </td>
            </tr>
            <tr>
                <td align="left" style="font-size:small;font-weight:bold;padding-left:15px;">'.Lang::trans('paymentpayshop_amount').':</td>
